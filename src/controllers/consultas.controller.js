...
<html>
            ...
            transporter.sendMail(mailOptions, (error) => {
                if (error) {
					...
					confirmConsulta(req.body.email);
...
// Función para enviar correo de confirmación a la persona que ingresó la SOLICITUD DE SERVICIO
confirmConsulta = (email, res) => {
	try{
	   if(email){
		  var transporter = nodemailer.createTransport({
			 host: "smtp.gmail.com",
								  ...
								  <!-- ESLOGAN -->
								   ...
								   <!-- /ESLOGAN -->
									 ...
									 <td width="400" height="50" align="center" style="font-family: Helvetica, arial, sans-serif; text-transform: uppercase;font-size: 20px; color: #2E338C; font-weight: bold;">
									  ...
									  <tr>
									 <td width="500" height="20" align="left" style="font-family: Helvetica, arial, sans-serif; font-size: 18px;color: #95a5a6">
									  Cordial saludo, esperando se encuentre muy bien. Hemos recibido una solicitud para obtener un servicio de nuestra IPS en el portal web, por ello, 
